...
if __name__ == '__main__':
    ...
    parser.add_argument('--archived_dir', type=str, default=None,
                        help='Archived models directory path (overrides config)')
    ...
    archived_dir = args.archived_dir if args.archived_dir else 'archived'  # Note: different from 'archive'
    ...
    checkpoint_path = os.path.join(configs.root_dir, 'code/TGCN', archived_dir, args.subset, checkpoint_name)
