...
def read_pose_file(filepath, features_dir=None):
    ...
    # Use provided features_dir or fallback to default location
    if features_dir is None:
        raise ValueError("features_dir must be provided to read_pose_file.")
...
class Sign_Dataset(Dataset):
    def __init__(self, index_file_path, split, pose_root, sample_strategy='rnd_start', num_samples=25, num_copies=4,
                 img_transforms=None, video_transforms=None, test_index_file=None, features_dir=None):
        ...
        self.features_dir = features_dir  # Store features directory
    ...
    def _load_poses(self, video_id, frame_start, frame_end, sample_strategy, num_samples):
        ...
        for i in frames_to_sample:
            ...
            # Pass features directory to read_pose_file
            pose = read_pose_file(pose_path, self.features_dir)
